...
{
    /**
     * This method allows the class implementing the contract to provide logic for handling offers
     * and returning discount applied
     * @param array $items
...
{
    private const string DISCOUNT_CODE = 'R01';
    ...
    public function apply(array $items, array $product_catalogues): float
    {
        ...
        // We are guaranteed to have at least 1 red widget here
